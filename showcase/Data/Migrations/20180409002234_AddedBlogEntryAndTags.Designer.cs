...
namespace showcase.Data.Migrations
{
    ...
    [Migration("20180409002234_AddedBlogEntryAndTags")]
    partial class AddedBlogEntryAndTags
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("showcase.Models.BlogEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("showcase.Models.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("showcase.Models.PortfolioEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("showcase.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("showcase.Models.BlogEntry", b =>
                {
                    b.HasOne("showcase.Models.Image", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("showcase.Models.Tag", b =>
                {
                    b.HasOne("showcase.Models.BlogEntry")
                        .WithMany("Tags")
                        .HasForeignKey("BlogEntryId");

                    b.HasOne("showcase.Models.PortfolioEntry")
                        .WithMany("Tags")
